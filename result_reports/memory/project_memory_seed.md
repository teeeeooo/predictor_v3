...
entries:
  ...
  - type: decision
    ...
    content: Phase 5A is closed and `docs/designs/2026-07-22-train-model-lifecycle-agent-assisted-experiment-design.md` remains authoritative. Phase 5B through Phase 5F are independently audited, merged, and complete. Phase 5F was accepted at exact head `fa13ddd75c5cf8a423d3ffc1fc046f552086e01a`, final independent audit PASS, required validation run `30197335156` success, and PR #33 squash merge `1f441c6d82545943aa160919c7d97d3a4b969580`. Its earlier audit FAIL heads `b5ce141711c3660e2ce38b738f58f478a333d251` and `e5558e82d7ca736bb45ca71eb94ab83b71a19950` remain historical evidence. The merged Phase 5F boundary shares one strict GUI/headless Experiment Specification and training application owner, records Core-owned start acknowledgement only after preflight, enforces total retry allowance across every resume, derives repository-owned build identity, returns detached read-only compatibility blocks, keeps validate/resolve read-only, and serializes writers without granting production authority. Phase 5G adds explicit external one-step proposals, application-owned configurable total budget, durable before/delta/after evidence, hard gates, deterministic campaign incumbent/leaderboard, honest Active/Bootstrap baselines, immutable approval-required recommendations, and separate operator-only budget extension. Its first two independent audits failed at `029fefdd783c21f380f6d43c6bd6efe403a52b28` and `a58f4584344fce921341bddc25091aef79403485`; successful runs `30199916760` and `30201667033` remain historical validation only. The bounded repairs preserve accepted proposal identity, stable training-meaning retry scope, and total attempt allowance across pre-start resume; block ID/metadata retry resets and pending replacement; fail closed on configured unresolved guardrail or instability evidence; and require finite-safe primary, guardrail, instability, ranking, and recommendation evidence with non-finite policy rejection and standard-JSON projection. Final independent audit accepted exact head `3344be1237f56752f8fcb607074152c53ea75c52`, required run `30203030680` succeeded, and PR #34 was guarded squash-merged as `cb9183353dd6492dff07012c4276e4beb2b582b8`. The merged boundary reuses Phase 5F execution and Candidate lifecycle, does not rewrite raw historical analysis, generate experiments, or mutate Definition/Active/deployment. Phase 5H snapshot/history/retention and final confirmation remain unstarted.
    keywords:
      - predictor_v3
      - Train/Admin
      - Phase 5A
