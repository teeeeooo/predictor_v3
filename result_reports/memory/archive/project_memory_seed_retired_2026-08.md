# Project Memory Seed Retired Entries - 2026-08

## Purpose

This archive preserves the pre-maintenance active memory entries retired or consolidated during the 2026-08 lifecycle cleanup. The original entry blocks and source traces are preserved verbatim below.

## Trace Policy

Use `result_reports/memory/project_memory_seed.md` for current recall. An archived entry may still describe a durable historical decision, but its former active wording is no longer authoritative when the current seed or owner documents supersede its state.

## Retired / Consolidated Entries
...
entries:
  ...
  - type: decision
    ...
    content: Phase 5A is closed and `docs/designs/2026-07-22-train-model-lifecycle-agent-assisted-experiment-design.md` remains authoritative. Phase 5B through Phase 5G are independently audited, merged, and complete; Phase 5G final audit accepted exact head `3344be1237f56752f8fcb607074152c53ea75c52`, required run `30203030680` succeeded, and PR #34 was squash-merged as `cb9183353dd6492dff07012c4276e4beb2b582b8`. Phase 5H remains on one Lane C Draft branch pending independent exact-head re-audit. Preserve its audit `FAIL` heads and successful validation-only runs: `009e4d3d668df2fc3df13a06aa22a8991ec67299`/`30280886312`, `97914c0285c7155ecfbd6da1fb9fa1d7c60f24a7`/`30286229720`, `ae20c626a12c15906c5ffb9e4f159875418caed4`/`30323789487`, and `c58413cabfa005154c1a5b70d80f2a3a355431a6`/`30375698091`. The bounded repairs bind snapshot materialization and complete captured artifacts to selected-run evidence, compute locked-test seal identity from data/membership/Targets/split/schema/evaluation/source hashes, require trusted opaque interactive authority plus one final decision, and block orphan confirmation Candidates. One versioned/hash-bound durable execution claim recovers the exact pending record. Start preparation embeds the exact running transition but is not actual-start proof; one execution-key OS lock permits process-restart recovery before separate immutable TrainingLifecycle Core-start acknowledgement and prevents concurrent duplicate execution. Retention inventory uses persisted/stable values rather than process time. After immutable locked-result publication, one finalization fence revalidates complete snapshot, seal/dataset/membership/Target/split/evaluation, result, and staged Candidate linkage inside the shared writer lock before atomic public finalization; failure leaves the seal consumed and exposes no Candidate. Terminal replay and migration/retention previews remain byte-invariant, and true lifecycle source references remain fail-closed when export/lease evidence is missing. Recommendation/confirmation cannot grant agent approval or bypass generic promotion policy. Core lifecycle persistence now selects a Windows path-based adapter for Candidate, run evidence, Active, recovery, and shared closeout artifacts. Its first audited head `967c8c4d29e8e05a966afb90531f12ba47c5c8f6` was invalidated because pre/post validation did not prevent root substitution before full-path mutation. The bounded repair pins every root-to-parent component with native no-delete-sharing handles for the entire mutation and opens lock/regular/exclusive leaves without following reparse points; deterministic substitution tests require external state to remain unchanged. POSIX retains its existing directory-FD durability path. Deployment Export remains a separate Windows portability follow-up, and native Windows execution remains external acceptance evidence.
    keywords:
      - predictor_v3
      - Train/Admin
      - Phase 5A
      ...
      - total retry allowance
      - detached compatibility block
      ...
      - Windows persistence
    assertionStatus: verified
    source: docs/designs/2026-07-22-train-model-lifecycle-agent-assisted-experiment-design.md; result_reports/records/2026-07/2026-07-25-train-admin-phase5d-model-management-ui.md; result_reports/records/2026-07/2026-07-26-train-admin-phase5d-ui-state-projection-audit-repair.md; result_reports/records/2026-07/2026-07-26-train-admin-phase5d-training-running-guidance-repair.md; result_reports/records/2026-07/2026-07-26-train-admin-phase5d-post-merge-closeout.md; result_reports/records/2026-07/2026-07-26-phase5e-deployment-export-predict-reload.md; result_reports/records/2026-07/2026-07-26-phase5e-reload-ordering-structured-failure-repair.md; result_reports/records/2026-07/2026-07-26-phase5e-refresh-ordering-ui-failure-boundary-repair.md; result_reports/records/2026-07/2026-07-26-phase5e-post-merge-closeout.md; result_reports/records/2026-07/2026-07-26-phase5f-core-ack-retry-compatibility-audit-repair.md; result_reports/records/2026-07/2026-07-26-phase5f-post-merge-closeout.md; result_reports/records/2026-07/2026-07-26-phase5g-agent-assisted-campaign-loop.md; result_reports/records/2026-07/2026-07-26-phase5g-post-merge-closeout.md; result_reports/records/2026-07/2026-07-28-phase5h-lifecycle-safety-audit-repair.md; result_reports/records/2026-07/2026-07-29-phase5h-transactional-finalization-recovery.md; result_reports/records/2026-07/2026-07-29-phase5h-durable-execution-start-recovery.md; result_reports/records/2026-08/2026-08-06-windows-model-lifecycle-persistence-compatibility.md

  - type: decision
    topic: Phase 5H abandon-and-restart confirmation recovery
    content: The seventh Phase 5H independent audit failed at exact head `ed20d081ded7621b145ff95faa0e56e96163e303`; successful run `30421708922` is validation-only evidence. The approved product decision supersedes actual-compute at-most-once and permanent permit-as-start-proof as recovery requirements. The bounded source implementation is complete on the same Draft PR: a confirmation child acquires an exact attempt-specific process-lifetime lock before its start request and holds it through exit; recovery probes it under the existing execution-key/lifecycle writers, never replaces live or uncertain children, and holds the acquired fence through immutable abandonment of a proven-ended attempt. A new attempt gets isolated run, permit, post-durability grant, liveness, and private staging identities and retrains from the beginning under the same canonical confirmation identity without resuming or mixing partial model, metric, manifest, Candidate, locked result, or terminal evidence. Failure before locked-seal consumption follows this restart contract; consumed seal without complete finalization abandons the whole Confirmation and requires a new seal and Confirmation. Complete durable terminal/Candidate pairs are revalidated and replay-only; simultaneous live compute and public/terminal finalization remain at-most-once. Generic supervision, child adoption, production mutation, migration/delete apply, merge, and Worker audit approval remain excluded. Fresh independent exact-head audit is required.
    keywords:
      - predictor_v3
      - Phase 5H
      - confirmation
      ...
      - no partial resume
    assertionStatus: verified
    source: docs/designs/2026-07-22-train-model-lifecycle-agent-assisted-experiment-design.md; result_reports/records/2026-07/2026-07-29-phase5h-abandon-and-restart-recovery-decision.md; result_reports/records/2026-07/2026-07-29-phase5h-abandon-and-restart-recovery-source.md; docs/WORK_PLAN.md

  - type: decision
    topic: Phase 5H atomic start-permit publication
    content: The sixth Phase 5H independent audit failed at exact head `7175060236ede4596246f64f6acf0d1b932075ca`; successful run `30416243161` is validation-only evidence. A confirmation start permit is written as canonical bytes to an attempt-private temporary artifact, flushed, file-fsynced, and byte-verified before an atomic exclusive final-path commit and containing-directory fsync. Pre-commit failure leaves no final permit, temporary residue is neither child-visible start evidence nor a retry blocker, and exact concurrent publication may reuse only identical evidence; malformed, conflicting, or tampered final evidence is preserved and fails closed. Its former permanent post-commit no-rerun direction is superseded by the later abandon-and-restart contract: the permit authorizes only its exact attempt, while proven process termination permits one isolated sequential replacement. Phase 5H stays on the same open Draft PR for independent exact-head re-audit, with no production confirmation/promotion, migration apply, retention/delete apply, merge, or Worker audit-PASS authority.
    keywords:
      - predictor_v3
      - Phase 5H
      - confirmation
  ...
  - type: decision
    ...
    content: The fifth Phase 5H independent audit failed at exact head `55141965c262bddd1fb1dd2b6692ed5bce99464d`; successful run `30413469249` is validation-only evidence. A confirmation child blocks at the Core work boundary after an identity-bound start request until the closeout owner durably publishes the exact confirmation/execution/attempt/protocol/training-meaning permit and sends the matching post-durability grant. The permit and grant authorize only that exact attempt, and stale children cannot consume replacement authority. Its former permanent post-permit no-rerun direction is superseded by the later process-liveness abandon-and-restart contract after proven child termination. Ordinary training remains outside the optional handshake. Phase 5H stays on the same open Draft PR for independent exact-head re-audit, with no production confirmation/promotion, migration apply, retention/delete apply, merge, or Worker audit-PASS authority.
    keywords:
      - predictor_v3
      - Phase 5H
      - confirmation
      ...
      - recovery
    assertionStatus: verified
    source: docs/designs/2026-07-22-train-model-lifecycle-agent-assisted-experiment-design.md; result_reports/records/2026-07/2026-07-29-phase5h-process-boundary-start-handshake-recovery.md; docs/WORK_PLAN.md

  - type: decision
    topic: Train/Admin Phase 4B canonical persistence foundation
    content: Phase 4B implements a versioned canonical Unified Feature manifest with deterministic opaque identities and complete-semantic generation hashing, generation-scoped Predict/ordered-ML/Derived/One-hot/Target-registry/Mapping-requirement projections, whole-contract validation, and scoped fingerprints. Production Train create_shell bootstraps the approved manifest and injects the filesystem adapter through a small application repository port; explicit schema_path construction is the legacy compatibility-only path, and no-argument service/controller/shell construction fails fast. Drafts retain their base generation, and the adapter holds a native POSIX or Windows cross-process file lock across parent validation and active-pointer replacement, so stale Save cannot replace a newer generation. Runtime generations and the active pointer live in per-user state rather than source-controlled config; the tracked manifest remains the bootstrap seed. Predict, ML, dependency-topological Derived, One-hot category, and Target presentation ordering are projected from their canonical owners and duplicate storage fields are cross-validated. Predict display_order is unique and bounded across the complete active-plus-inactive Predict ordering contract. Failures preserve the draft, active pointer, and immutable history; rollback remains available. schema.csv/features.csv are generated compatibility surfaces, while mapping.json, model artifacts, promotion, and runtime cutover remain outside the transaction. The original Windows simulation did not model Windows file-fsync rejection of read-only descriptors; the corrected shared owner opens staging-bundle and active-pointer files read/write only on Windows while retaining POSIX read-only file and directory durability behavior. Native Windows source-runtime acceptance then exposed a second persistence defect: bundle metadata used host-native relative paths and bootstrap self-reuse assumed the pointed generation was complete. New publications persist `/`-separated file identities on every host; separator-only legacy Windows metadata is normalized only for strict read validation, while portable Generation IDs reject POSIX/Windows path forms. A parentless bootstrap may reconstruct a missing or bundle-marker-free generation only when all extant residue exactly matches the same candidate; complete or conflicting immutable state remains fail-closed. Fresh PR #56 audit proved that matching-residue reconstruction also needs mutation-time containment: POSIX now writes through an identity-checked generation directory descriptor, while Windows rejects reparse/junction paths and pins root-to-generation directories with no-delete-sharing handles so validation-to-mutation substitution cannot redirect writes outside the workspace. Windows Generation IDs also reject device/reserved aliases, trailing dot/space, stream/colon, forbidden characters, and controls while normal semantic/hash IDs remain valid. Native Windows execution remains external acceptance evidence after independent re-audit/merge.
    keywords:
      - predictor_v3
      - Train/Admin
      - Phase 4B
  ...
  - type: decision
    ...
    keywords:
      ...
      - model group
    assertionStatus: verified
    source: docs/designs/2026-07-17-train-admin-phase-4-unified-feature-manager.md; result_reports/records/2026-07/2026-07-17-train-admin-feature-contract-cutover-boundaries.md; result_reports/records/2026-07/2026-07-22-train-admin-phase4h-4i-runtime-closeout.md

  - type: decision
    topic: Train/Admin model promotion and standalone Predict generation boundaries
    content: Phase 4 implements compatibility classification, TrainShell-local atomic generation cutover, and standalone Predict checks at startup, prediction, and explicit reload; a stale process preserves existing rows/results and blocks new prediction when safe reload fails. Definition publication, training candidate publication, and active-model promotion remain separate. Phase 5 still owns candidate-result UX and explicit promotion; only the artifact/model owner may promote a validated current-compatible candidate, promotion failure preserves the prior compatible model, and automatic promotion/activation remains excluded. One-hot acceptance follows source-mode owners: Data Definition CRUD for static vocabulary, Data Mapping reconciliation for mapping-backed options, and read-only or bounded policy for external/provider vocabulary.
    keywords:
      - predictor_v3
      - Train/Admin
      - candidate artifact
