"""Tkinter Entry-grid adapter for :mod:`apps.calculator.ui.table_grid_model`.
...
from apps.calculator.ui.table_grid_model import GridColumn, GridRow, TableGridModel
