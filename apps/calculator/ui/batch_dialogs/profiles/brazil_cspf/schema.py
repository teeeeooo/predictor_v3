...
BRAZIL_CSPF_MATRIX_SPEC = BatchMatrixSpec(
    ...
    result_metrics=(
        (THREE_POINT_CSPF, "CSPF 3pt", BATCH_MATRIX_RESULT_PRIMARY_WIDTH_CHARS),
        (THREE_POINT_CSTL, "CSTL 3pt", BATCH_MATRIX_RESULT_SECONDARY_WIDTH_CHARS),
        (THREE_POINT_CSEC, "CSEC 3pt", BATCH_MATRIX_RESULT_SECONDARY_WIDTH_CHARS),
        (TWO_POINT_CSPF, "CSPF 2pt", BATCH_MATRIX_RESULT_PRIMARY_WIDTH_CHARS),
        (RULE_1, "Rule 1", BATCH_MATRIX_RESULT_PRIMARY_WIDTH_CHARS),
        (MEASURED_29_HALF_EER, "29°C EER 실측", BATCH_MATRIX_RESULT_SECONDARY_WIDTH_CHARS),
        (CALCULATED_29_BIN_EER, "29°C EER 계산", BATCH_MATRIX_RESULT_SECONDARY_WIDTH_CHARS),
