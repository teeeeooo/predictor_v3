...
New table interaction behavior is owned by :mod:`apps.calculator.ui.table`.
...
from apps.calculator.ui.batch.models import BatchColumnRole
...
from apps.calculator.ui.table.surface import TkTableSurface as BatchTableSurface
