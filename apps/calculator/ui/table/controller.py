...
from apps.calculator.ui.layout_constants import TABLE_ACTIVE_BG, TABLE_SELECTED_BG
...
from apps.calculator.ui.table.roles import is_mutable
from apps.calculator.ui.table.surface import TkTableSurface
