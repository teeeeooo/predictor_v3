"""Compact read-only comparison result for Tkinter ISO/ISEER 2-point."""
...
class IsoIseer2PointResultTable:
    """Section-local wrapper preserving result, status, text, and export APIs."""
    ...
    def __init__(self, parent: tk.Widget, *, title: str = "ISO / ISEER 결과") -> None:
        ...
        self.table = CompactResultGrid(
            ...
            column_widths=(18, 12, 12, 12, 12, 12),
            surface_role="two_point_comparison_table",
        )
