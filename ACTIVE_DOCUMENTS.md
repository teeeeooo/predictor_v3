...
| `docs/ui_ux/07_WINDOW_GEOMETRY_AND_VIEWPORT_POLICY.md` | Window geometry, viewport, and auto-fit policy owner | UI/UX root, layout/window geometry tasks, nested notebook/detail refit tasks | toolkit adapters, app shell/window geometry helpers, future WPF/PySide/Web geometry implementations |
