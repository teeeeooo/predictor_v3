...
| `docs/ui_ux/06_PYSIDE6_VISUAL_AND_TABLE_PARITY_HARVEST.md` | predictor_v3-specific harvest of retired Train/Predict visual and table UX ideas | Arc 9.5 Predict/Train visual parity tasks | `docs/designs/assets/predict_ref_img.png`, `docs/designs/assets/train_ref_img.png`, `ui_common.visual_tokens`, table UX parity gaps |
