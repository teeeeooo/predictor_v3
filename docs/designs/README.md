...
| --- | --- | --- |
| `2026-07-14-train-admin-ui-ux-overhaul-document-set.md` | Navigation index for the Train/Admin overhaul governing design, five implementation phases, the Phase 4A closeout amendment, and deferred Predict boundary. | Locating the correct Train/Admin phase design before implementation. |
...
| `2026-07-17-train-admin-phase-4-unified-feature-manager.md` | Current Phase 4 parent design for unified Predict/ML Feature authoring, safe multi-contract persistence, and live owner refresh. | Reviewing the complete Phase 4 goal, scope, slice boundaries, and final acceptance. |
...
| `2026-07-14-train-admin-phase-5-train-model-shell-ux-overhaul.md` | Deferred Phase 5 design for training-data selection, explicit training, progress, results, Predict availability, and shell/Diagnostics separation. | Planning Train/Model UX after Unified Feature Manager stabilization. |
| `2026-07-14-future-predict-ui-ux-overhaul-boundary.md` | Deferred boundary and prerequisites for the later Predict UI/UX overhaul. | Planning Predict UX after Train/Admin Phase 5. |
