...
| `2026-06-27-pyside6-train-predict-rewrite-design-gate.md` | active reference | Rewrite Train/Predict as new PySide6 apps under `apps/predict/` and `apps/train/`; keep legacy PyQt5 `ui/` reference-only until retirement. | `PROJECT_CHARTER.md`, `docs/architecture/project_architecture.md`, `docs/WORK_PLAN.md` | Planning Train/Predict rewrite preflight, skeleton, or legacy retirement decisions. |
| `2026-06-27-pyside6-train-predict-ui-implementation-spec.md` | active reference | Defines the PySide6 PredictWorkspace, variable-size input/results tables, Trainer tabs, package boundaries, and implementation slices. | PySide6 Train/Predict design gate plus architecture/work plan owners | Implementing PySide6 Train/Predict skeleton or follow-up UI slices. |
