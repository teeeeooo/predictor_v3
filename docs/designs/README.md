...
| `2026-06-27-pyside6-train-predict-rewrite-design-gate.md` | active reference | Rewrite Train/Predict as new PySide6 apps under `apps/predict/` and `apps/train/`; visual reference assets guide Arc 9.5 layout parity but are not pixel-perfect targets. | `docs/architecture/pyside6_train_predict_architecture.md`, `docs/ui_ux/06_PYSIDE6_VISUAL_AND_TABLE_PARITY_HARVEST.md`, `PROJECT_CHARTER.md`, `docs/architecture/project_architecture.md`, `docs/WORK_PLAN.md` | Planning Train/Predict rewrite preflight, visual parity, or legacy retirement decisions. |
