...
| --- | --- | --- |
| `2026-07-14-train-admin-ui-ux-overhaul-document-set.md` | Navigation index for the Train/Admin overhaul governing design, five implementation phases, and deferred Predict boundary. | Locating the correct Train/Admin phase design before implementation. |
...
| `2026-07-17-train-admin-phase-4-unified-feature-manager.md` | Proposed/current Phase 4 design for unified Predict/ML Feature authoring, safe multi-contract persistence, and live owner refresh. | Current-state audit and design finalization before Phase 4 production implementation. |
