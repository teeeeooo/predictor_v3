...
| --- | --- | --- |
| `2026-07-13-all-standards-core-refactor-design.md` | Governing inventory, contract, and owner design for active non-AHRI Calculator standard cores. | Refactoring or reviewing EN 14825, ISO 16358, KS C 9306, Brazil, or remaining active Calculator core routes. |
