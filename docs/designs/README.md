...
| `2026-07-14-train-admin-phase-1-mapping-data-foundation.md` | Phase 1 design; implementation and merge complete, with deferred native evidence tracked separately. | Historical or boundary review for Train/Admin Phase 1. |
