...
| `2026-06-27-pyside6-train-predict-rewrite-design-gate.md` | active reference | Rewrite Train/Predict as new PySide6 apps under `apps/predict/` and `apps/train/`; keep legacy PyQt5 `ui/` reference-only until retirement. | `docs/architecture/pyside6_train_predict_architecture.md`, `PROJECT_CHARTER.md`, `docs/architecture/project_architecture.md`, `docs/WORK_PLAN.md` | Planning Train/Predict rewrite preflight, skeleton, or legacy retirement decisions. |
