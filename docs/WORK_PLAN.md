...
1. **233F - batch table viewport/scroll containment**
   - Keep Add Row from pushing rows below the visible dialog area.
   - Do not mix this with batch copy/export behavior or two-row matrix layout.
