...
> **Reference source only.** This document preserves uploaded visual
> inspiration for translation into `predictor_v3`; it is not an active UI/UX
> SSOT or an implementation specification. The adopted project-wide visual
> architecture owner is `docs/ui_ux/04_VISUAL_DESIGN_ARCHITECTURE.md`.
