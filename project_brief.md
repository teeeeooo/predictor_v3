...
- **ISO16358-2 HSPF / AS/NZS 경계:** ISO16358-2 HSPF는 Track A common ISO path와 Track B AS/NZS HSPF calculator(Energy Rating SEER Excel workbook reference)로 분리합니다. AS/NZS row-level exact reconstruction 작업은 Z-phase로 보류되었습니다.
