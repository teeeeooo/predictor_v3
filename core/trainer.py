# core/trainer.py — 학습 파이프라인 및 하이퍼파라미터/피처 최적화
import os
import joblib
import pandas as pd
import numpy as np
...
from core.constants import TRAIN_DATA_FILE, MODEL_FILE, MODEL_DIR
from core.models import MODEL_REGISTRY, get_model_config
from core.data_pipeline import load_and_preprocess, prepare_pipeline
