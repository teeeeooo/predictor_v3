...
class ISO16358Calculator:
    ...
    def _ks_hspf_stage_value(
        ...
        if point == "-7" and stage in ("min", "rated", "intermediate"):
            if "7" in stage_data:
                factor = 0.601 if quantity == "capacity" else 0.801
