...
def assemble_result(
    *,
    ...
    total_energy = compressor_energy + resistance_energy
    if total_heating <= 0 or total_energy <= 0:
        raise ValueError("Multi-capacity HSPF2 seasonal totals must be positive")
    raw_base = total_heating / total_energy
    ...
    return {
        ...
        "total_load": total_heating,
        "total_heating_btu": total_heating,
        "total_compressor_energy_wh": compressor_energy,
        "total_resistance_energy_wh": resistance_energy,
